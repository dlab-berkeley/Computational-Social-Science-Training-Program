---
title: "6-4 Regression Discontinuity Design - Solutions"
author: ""
...
calculate_rdd_and_bandwidth <- function(df_split, bw){ # two arguments the function takes
  ...
  mse_data <- data.frame(
    ...
    pred = predict(rdd_model$model[[1]]),  # pull models from the object because rrd does not automatically return them
