---
title: "6-8: SuperLearner and LTMLE - Solutions"
output:
...
Then the final TMLE estimator will be **consistent**. Consistent means that as the sample size grows to infinity, the bias will drop to 0. We're going to explore this idea in depth. The example we will go through here is drawn from Katherine Hoffman's [blog](https://www.khstats.com/blog/tmle/tutorial-pt2/). She also provides visual guides to [SuperLearner](https://github.com/hoffmakl/causal-inference-visual-guides/blob/master/visual-guides/Superlearner.pdf) and [TMLE](https://github.com/hoffmakl/causal-inference-visual-guides/blob/master/visual-guides/TMLE.pdf). I recommend consulting the TMLE visual guide in particular as you work through these steps.
