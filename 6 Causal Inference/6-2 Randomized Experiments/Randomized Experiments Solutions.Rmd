---
title: '6-1 Randomized Experiments - Solutions'
author: ""
...
Our ATE calculated using complete randomization (`r ATE_comp`) is much closer to the true `ATE` (`r ATE`).
...
# calculate treatment status from cluster randomization assignment
# ----------
df <- 
  df %>%                                     # pass data 
...
The ATE based on cluster assignment (`r ATE_clus`) is also very close to the true `ATE` (`r ATE`), closer than the observed estimate.
...
# calculate treatment status from block randomization assignment
# ----------
df <- 
  df %>%      
...
Yet again, the ATE obtained via block assignment (`r ATE_bloc`) is much closer to the true `ATE`(`r ATE`) than the observed estimate.
