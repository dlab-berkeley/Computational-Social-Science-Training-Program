...
**<span style="color:blue;">QUESTION 10:</span>** Create a new frequency table for `A_comp` and `Y_comp` (of whichever layout you prefer) and then assign the new estimated average treatment effect to the variable `ATE_comp`. Then briefly compare your result to the true parameter `ATE`.hen briefly compare your result to the true parameter `ATE`.
